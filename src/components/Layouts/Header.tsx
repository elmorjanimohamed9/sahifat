                        ...
                        <div className="dropdown shrink-0 flex">
                                    ...
                                    isAuthenticated && user ? (
                                        <div className="flex items-center">
                                            <img
                                                ...
                                                src={user?.photoUrl || "/assets/images/user-profile.jpeg"}
                                                alt="userProfile"
                                            />
                                        </div>
                                    ) : (
                            ...
                            >
                                {isAuthenticated && user ? (
                                        ...
                                        <li>
                                            <div className="flex items-center px-4 py-4">
                                                ...
                                                <div className="ltr:pl-4 rtl:pr-4 truncate">
                                                    ...
                                                    <button
                                                        type="button"
                                                        className="text-black/60 truncate max-w-[150px] hover:text-primary dark:text-dark-light/60 dark:hover:text-white"
                                                    >
                                    ...
                                    <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                        <li>
                                            <Link to="/auth/boxed-signin" className="dark:hover:text-white">
                                                {t('login')}
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to="/auth/boxed-signup" className="dark:hover:text-white">
                                                {t('register')}
                                            </Link>
                                        </li>
                                    </ul>
